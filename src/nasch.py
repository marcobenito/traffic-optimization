...
@njit(cache=True)
def roundabout(U, P, vmax, ITL, entrance=None, exits=None):
...
#                
    ...
    #         dens +=1
    # dens = dens/n
    # print('Final density: ', dens)
    # print('Total cars that entered the road: ', np.sum(entrance[2,:]))
    # print('Total cars that exited the road: ', np.sum(exit[2, :]))
    return U, means
